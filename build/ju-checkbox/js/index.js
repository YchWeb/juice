...
var JuCheckbox = function () {
    function JuCheckbox(query, options) {
        _classCallCheck(this, JuCheckbox);

        if (!query) {
            try {
                this.mychecbox = document.querySelector('.ju-checkbox');
            } catch (e) {
                console.log(e);
                return false;
            }
            ...
            try {
                this.mychecbox = document.querySelector(query);
            } catch (e) {
                console.log(e);
                return false;
            }
